...
import (
	...
	clientapi "github.com/libopenstorage/openstorage/api/client"
...
func (s *Server) Start() error {
	...
	clientapi.RegisterOpenStorageClusterServer(s.server, s)
	reflection.Register(s.server)

	// Start listening for requests
	logrus.Infof("gRPC API Server ready on %s", s.Address())
